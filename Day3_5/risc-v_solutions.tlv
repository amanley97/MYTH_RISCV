...
\TLV
   ...
   |cpu
      ...
      @1
         ...
         // BRANCH INSTRUCTIONS
         $is_beq  = $dec_bits ==? 11'bx_000_1100011; //branch EQUAL instruction. 
         $is_bne  = $dec_bits ==? 11'bx_001_1100011; //branch NOT EQUAL instruction. 
         $is_blt  = $dec_bits ==? 11'bx_100_1100011; //branch LESS THAN instruction. 
         $is_bge  = $dec_bits ==? 11'bx_101_1100011; //branch GREATER OR EQUAL instruction. 
         $is_bltu = $dec_bits ==? 11'bx_110_1100011; //branch LESS THAN (unsigned) instruction. 
         $is_bgeu = $dec_bits ==? 11'bx_111_1100011; //branch GREATHER OR EQUAL (unsigned) instruction.
