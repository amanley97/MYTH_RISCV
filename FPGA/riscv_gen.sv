...
logic [30-1:0] CPU_imem_rd_addr_a0,
               CPU_imem_rd_addr_a1;
...
logic [31:0] CPU_sltiu_result_a3;

// For |cpu$sltu_result.
logic [31:0] CPU_sltu_result_a3;
...
logic clkP_CPU_rs2_valid_a2 ;
   ...
   //
      ...
      always_ff @(posedge clk) CPU_imem_rd_addr_a1[30-1:0] <= CPU_imem_rd_addr_a0[30-1:0];
